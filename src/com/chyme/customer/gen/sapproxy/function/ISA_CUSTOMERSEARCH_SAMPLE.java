...
public class ISA_CUSTOMERSEARCH_SAMPLE extends Function
{
	...
	static
	{
		funcDesc = new FunctionDescriptor("ISA_CUSTOMERSEARCH_SAMPLE","ISA_CUSTOMERSEARCH_SAMPLE");
	...
	public ISA_CUSTOMERSEARCH_SAMPLE() 
	{
		super("ISA_CUSTOMERSEARCH_SAMPLE");
	}
